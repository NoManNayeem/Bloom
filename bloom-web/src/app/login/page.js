...
export default function LoginPage() {
  ...
  // Prefill for quick local testing – change to '' in production if you like
  const [form, setForm] = useState({ username: 'Nayeem', password: 'password' });
        ...
        >
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-gray-600">
              Use your Bloom account to access the survey.
            </p>
          </div>
